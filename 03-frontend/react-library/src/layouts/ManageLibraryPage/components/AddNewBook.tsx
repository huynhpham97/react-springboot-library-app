                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-3 mb-3'>
                                ...
                                <ul id='addNewBookId' className='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
                                    ...
                                    <li><a onClick={() => categoryField('DB')} className='dropdown-item'>Data</a></li>
                                    <li><a onClick={() => categoryField('DO')} className='dropdown-item'>DevOps</a></li>
                                </ul>
                            </div>
                        </div>
